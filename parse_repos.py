...
.page-header {{ background: linear-gradient(135deg, #dc3545 0%, #e74c3c 50%, #f1aeb5 100%); color: white; padding: 30px; text-align: center; }}
.page-header .header-content {{ display: flex; flex-direction: column; align-items: center; }}
...
function exitApplication() {{
    window.close();
    // Ha a window.close() nem működik (biztonsági okokból), átirányítás az üres oldalra
    setTimeout(function() {{
